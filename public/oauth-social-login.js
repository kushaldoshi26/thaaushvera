...
async function loginWithGoogle() {
    try {
        // Initialize Google Sign-In or use OAuth flow
        if (typeof google !== 'undefined' && google.accounts) {
            ...
            // Fallback: Open Google OAuth dialog
...
async function loginWithFacebook() {
    try {
        // Initialize Facebook SDK or use OAuth flow
        if (typeof FB !== 'undefined') {
            FB.login(handleFacebookCallback, { scope: 'public_profile,email' });
        } else {
            // Fallback: Open Facebook OAuth dialog
