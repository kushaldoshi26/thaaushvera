    ...
    <div class="admin-content-wrap" id="adminContentWrap">
        <header class="admin-topbar">
            ...
            <div class="topbar-actions">
                ...
                <form method="POST" action="{{ route('admin.logout') }}" style="margin:0;" onsubmit="localStorage.removeItem('auth_token'); localStorage.removeItem('currentUser'); localStorage.removeItem('token'); localStorage.removeItem('user'); localStorage.removeItem('isLoggedIn'); sessionStorage.removeItem('login_popup_shown');">
                    @csrf
