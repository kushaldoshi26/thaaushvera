...
<style>
    ...
    .hero-banner {
        width: 100%;
        height: 600px;
        background: url('{{ asset("assets/img/about-banner.png") }}') center/cover no-repeat, url('{{ asset("assets/img/banner1.png") }}') center/cover no-repeat;
        position: relative;
    }
    ...
    .standfor-item:first-child { border-left: none; }
    .standfor-item:hover { background: rgba(198,164,92,0.03); }
    ...
    .approach-content h3 { margin-bottom: 8px; }
    ...
    footer .footer-top, footer .footer-columns, footer .footer-bottom { background: var(--navy); }

    @media (max-width: 968px) {
        .origin-grid, .standfor-grid, .multi-grid { grid-template-columns: 1fr; }
        .standfor-item { border-left: none; border-top: 1px solid rgba(198,164,92,0.15); }
        .standfor-item:first-child { border-top: none; }
        .about-hero h1 { font-size: 48px; }
        .multi-grid::before { display: none; }
    }

    @media (max-width: 768px) {
        .hero-banner { height: 400px; }
        .hero-content-about { left: 5%; max-width: 90%; }
        .about-hero h1 { font-size: 40px; }
        .origin-section, .standfor-section, .multi-section { padding: 80px 2rem; }
        .standfor-item { padding: 40px 20px; }
    }
</style>
@endpush
    ...
    <section class="origin-section">
        <div class="origin-grid">
            ...
            <div class="origin-image">
                <img src="{{ asset('assets/img/about1.png') }}" alt="Botanical Heritage" onerror="this.src='{{ asset('assets/img/ritual-image.png') }}'">
            </div>
        </div>
    </section>
        ...
        <div class="standfor-grid">
            <div class="standfor-item">
                <div class="standfor-icon">
                    <svg viewBox="0 0 24 24"><path d="M12 2C12 2 8 4 8 8C8 10 9 12 12 14C15 12 16 10 16 8C16 4 12 2 12 2Z" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 14C12 14 8 16 8 20C8 22 10 24 12 24C14 24 16 22 16 20C16 16 12 14 12 14Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="standfor-item">
                <div class="standfor-icon">
                    <svg viewBox="0 0 24 24"><path d="M12 2L4 7V12C4 16.5 7 20.5 12 22C17 20.5 20 16.5 20 12V7L12 2Z" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="12" r="3"/></svg>
                </div>
            ...
            <div class="standfor-item">
                <div class="standfor-icon">
                    <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 1V3M12 21V23M4.22 4.22L5.64 5.64M18.36 18.36L19.78 19.78M1 12H3M21 12H23M4.22 19.78L5.64 18.36M18.36 5.64L19.78 4.22" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="standfor-item">
                <div class="standfor-icon">
                    <svg viewBox="0 0 24 24"><path d="M12 2C12 2 8 4 8 8C8 10 9 12 12 14C15 12 16 10 16 8C16 4 12 2 12 2Z" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 8C6 9 4 11 4 14C4 17 6 20 9 21" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 8C18 9 20 11 20 14C20 17 18 20 15 21" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
