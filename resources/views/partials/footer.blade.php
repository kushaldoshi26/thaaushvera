<footer>
    ...
    <div class="footer-columns">
        ...
        <div class="footer-column">
            ...
            <ul class="footer-links">
                ...
                <li><a href="{{ route('ritual') }}">Ritual</a></li>
        ...
        <div class="footer-column">
            ...
            <ul class="footer-contact">
                ...
                <li>
                    ...
                    <a href="mailto:aushveraglobalbiz1718@gmail.com" style="color: inherit; text-decoration: none;">aushveraglobalbiz1718@gmail.com</a>
                </li>
            </ul>
            <div class="footer-social">
                <a href="https://www.instagram.com/theaushvera?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="footer-bottom">
        <p>© {{ date('Y') }} AUSHVERA. All rights reserved. | <a href="{{ route('terms') }}" style="color: #C6A75E; text-decoration: none;">Terms &amp; Conditions</a></p>
    </div>
</footer>
