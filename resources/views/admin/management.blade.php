...
<body style="background: #F7F4EE;">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 text-white overflow-y-auto fixed h-screen" style="background: #0B1C2D; border-right: 1px solid rgba(198, 167, 94, 0.2);">
            ...
            <nav class="p-4">
                <!-- Dashboard -->
                <a href="/admin" class="block py-2 px-4 rounded hover:bg-[#C6A75E]/10 mb-2">
                    📊 Dashboard
                </a>
                ...
                <div class="sidebar-item mb-2">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/admin/orders?status=pending" class="block py-2 px-4 hover:bg-[#C6A75E]/10 rounded">Pending Orders</a></li>
                        <li><a href="/admin/orders?status=completed" class="block py-2 px-4 hover:bg-[#C6A75E]/10 rounded">Completed</a></li>
                    </ul>
                </div>
                ...
                <div class="sidebar-item mb-2">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/admin/register" class="block py-2 px-4 hover:bg-[#C6A75E]/10 rounded">➕ Create Admin</a></li>
